...
namespace XafBlazorViewItemUrlConfiguration.Win
{
    public class ApplicationBuilder : IDesignTimeApplicationFactory
    {
        public static WinApplication BuildApplication(string connectionString)
        {
            ...
            builder.UseApplication<XafBlazorViewItemUrlConfigurationWindowsFormsApplication>();
            builder.Modules
                .AddCloning()
                ...
                .Add<XafBlazorViewItemUrlConfiguration.Module.XafBlazorViewItemUrlConfigurationModule>()
                .Add<XafBlazorViewItemUrlConfigurationWinModule>();
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options =>
                {
                    options.PreFetchReferenceProperties();
                })
                    .WithDbContext<XafBlazorViewItemUrlConfiguration.Module.BusinessObjects.XafBlazorViewItemUrlConfigurationEFCoreDbContext>((application, options) =>
                    {
