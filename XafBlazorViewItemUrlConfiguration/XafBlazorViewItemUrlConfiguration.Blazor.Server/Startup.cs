...
namespace XafBlazorViewItemUrlConfiguration.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.UseApplication<XafBlazorViewItemUrlConfigurationBlazorApplication>();
                builder.Modules
                    .AddCloning()
                    ...
                    .Add<XafBlazorViewItemUrlConfigurationBlazorModule>();
                builder.ObjectSpaceProviders
                    .AddSecuredEFCore(options =>
                    {
                        options.PreFetchReferenceProperties();
                    })
                    .WithDbContext<XafBlazorViewItemUrlConfiguration.Module.BusinessObjects.XafBlazorViewItemUrlConfigurationEFCoreDbContext>((serviceProvider, options) =>
                    {
